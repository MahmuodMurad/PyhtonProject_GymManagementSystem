...
class Ui_Form3(object):
    ...
    def setupUi(self, Form3):
        ...
        self.label_31.setGeometry(QtCore.QRect(280, 610, 250, 31))
    ...
    def update(self):
        ...
        self.times = self.lineEdit_12.text()
        self.times_lift = self.lineEdit_13.text()
        ...
        c.execute(f"update players_datas set paidUp = '{self.paidUp}' , paymentDate = '{self.paymentDate}' ,renewDate = '{self.renewDate}',subtype ='{self.subtype}', times ='{self.times}',times_lift ='{self.times_lift}' where name='{self.name}'")
